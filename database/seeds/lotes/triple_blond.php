...
class triple_blond extends Seeder
{
    public function run()
    {
        ...
        $receta->cocinar('2021-06-29')
            ->macerar()
                ->malta(Malta::byNombre('Château Pilsen 2RS'), Scalar::Weight('4485 g'))
                    ->malta(Malta::byNombre('Château Cara Blond'), Scalar::Weight('529 g'))
                    ->malta(Malta::byNombre('Château Cara Clair'), Scalar::Weight('230 g'))
                    ->malta(Malta::byNombre('Château Wheat Blanc'), Scalar::Weight('230 g'))
				...
				->agua(Scalar::Volume('19 l'))
                    ...
                    ->final(Scalar::Volume('24.5 l'))
                ->densidad(Scalar::Density('1.050 sg'))
            ->hervir(CarbonInterval::minutes(75))
                ->lupulo(Lupulo::byNombre('Columbus'), Scalar::Weight('9.44 g'), CarbonInterval::minutes(55), 17.3)
                ->lupulo(Lupulo::byNombre('Cascade'), Scalar::Weight('27.95 g'), CarbonInterval::minutes(5), 6.4)
				->final(Scalar::Volume('15 l'))
            ->fermentar('Anvil 7.5 gl')
                ->levadura('BE-134', 'Lavada')
				->inicio(Scalar::Volume('16.5 l'), Scalar::Density('1.079 sg'))
